 ...
 */
public class DrinksFragment extends Fragment implements OnSortTypeChangedListener, ItemClickCallback {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    menus = new MenuFactory().getDrinks();
    Collections.sort(menus, Menu.priceComparator);


    adapter = new DrinksAdapter(getContext(), menus);
  ...
  public void onItemClick(int p) {
    callback.onMenuSelected(menus.get(p), 1);
  }
